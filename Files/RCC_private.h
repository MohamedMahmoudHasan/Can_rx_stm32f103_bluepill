...
#define RCC_MCO_1                25
#define RCC_MCO_2                26
#define WAIT_HSE_GET_READY        BIT_IS_CLEAR(RCC_CR,RCC_HSE_IS_READY)       /*HSE FLAG IS READY*/
#define WAIT_HSI_GET_READY        BIT_IS_CLEAR(RCC_CR,RCC_HSI_IS_READY)       /*HSI FLAG IS READY*/
